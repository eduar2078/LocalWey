...
<head>
    ...
    <title>Localwey - Barberías en Bolívar</title>
    ...
    <header class="bg-primary text-white shadow sticky-top">
        <div class="container py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
            ...
            <nav class="small">
                ...
                <span id="breadcrumb-current">Barberías en Bolívar</span>
            </nav>
        </div>
    </header>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="filter-categories">
                                <div class="form-check mb-1">
                                    ...
                                    <label class="form-check-label">Corte de cabello</label>
                                </div>
                                <div class="form-check mb-1">
                                    <input class="form-check-input" type="checkbox">
                                    <label class="form-check-label">Barba</label>
                                </div>
                                <div class="form-check mb-1">
                                    <input class="form-check-input" type="checkbox">
                                    <label class="form-check-label">Cejas</label>
                                </div>
                            </div>
                        </div>
            ...
            <section class="col-lg-8 col-xl-9">
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        <h4 class="fw-bold text-primary mb-1" id="list-title">
                            Barberías en Bolívar
                        </h4>
                        <p class="text-muted small mb-0" id="list-description">
                            Barberías recomendadas con los mejores estilos y atención
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row g-3 align-items-start">
                        ...
                        <div class="col-md-9">
                            <div class="card-body py-2">
                                <h6 class="fw-semibold mb-1" id="entity-name">Barbería Old School</h6>
                                <div class="small text-muted mb-1" id="entity-meta">
                                    ★★★★★ · 4.8 · Corte & Barba
                                </div>
                                <div class="small text-muted mb-2">
                                    <i class="fas fa-location-dot me-1"></i>
                                    <span id="entity-address">Bolívar, Calle 10 #45</span>
                                </div>
                                <button
                ...
                <div class="card mb-3 border-0 entity-card">
                    <div class="row g-3 align-items-start">
                        ...
                        <div class="col-md-9">
                            <div class="card-body py-2">
                                <h6 class="fw-semibold mb-1" id="entity-name">Barber Kings</h6>
                                <div class="small text-muted mb-1" id="entity-meta">
                                    ★★★★☆ · 4.5 · Estilo moderno
                                </div>
                                <div class="small text-muted mb-2">
                                    <i class="fas fa-location-dot me-1"></i>
                                    <span id="entity-address">Bolívar, Avenida Central #22</span>
                                </div>
                                <button
                                    class="btn btn-primary btn-sm rounded-pill px-4 fw-semibold d-inline-flex align-items-center gap-2"
                                    data-bs-toggle="modal"
                ...
                <div class="card mb-3 border-0 entity-card">
                    <div class="row g-3 align-items-start">
                        ...
                        <div class="col-md-9">
                            <div class="card-body py-2">
                                <h6 class="fw-semibold mb-1" id="entity-name">Estilo Urbano Barber</h6>
                                <div class="small text-muted mb-1" id="entity-meta">
                                    ★★★★☆ · 4.6 · Estilo urbano
                                </div>
                                <div class="small text-muted mb-2">
                                    <i class="fas fa-location-dot me-1"></i>
                                    <span id="entity-address">Bolívar, Zona Comercial #18</span>
                                </div>
                                <button
                                    class="btn btn-primary btn-sm rounded-pill px-4 fw-semibold d-inline-flex align-items-center gap-2"
                                    data-bs-toggle="modal"
                                    ...
                                    <div class="card shadow-sm mb-4">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-0 text-muted" id="modal-entity-description">
                                                Barbería de estilo clásico y urbano, especializada en cortes modernos,
                                                barba profesional y asesoría de imagen masculina.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="row g-2" id="modal-entity-gallery">
                                                <div class="col-4">
                                                    <img src="https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9" class="img-fluid rounded">
                                                </div>
                                                <div class="col-4">
                                                    <img src="https://images.unsplash.com/photo-1503342217505-b0a15ec3261c" class="img-fluid rounded">
                                                </div>
                                                <div class="col-4">
                                                    <img src="https://images.unsplash.com/photo-1599351431202-1e0f0137899a" class="img-fluid rounded">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <div id="modal-entity-services">
                                                <span class="badge bg-secondary me-1 mb-1">Corte clásico</span>
                                                <span class="badge bg-secondary me-1 mb-1">Fade</span>
                                                <span class="badge bg-secondary me-1 mb-1">Barba</span>
                                                <span class="badge bg-secondary me-1 mb-1">Cejas</span>
                                            </div>
                                        </div>
                                    </div>
