                ...
                <div class="card border-0 shadow-sm rounded-4 sidebar-sticky">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div id="filter-categories" class="d-flex flex-column gap-2 mb-4">
                            ...
                            ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="cat-rest">
                                    <label class="form-check-label small fw-semibold" for="cat-rest">
                                        <i class="<?php echo $value["f102_icono"]; ?> me-1 text-primary"></i><?php echo ucfirst(strtolower($value["f102_tipo_negocio"])); ?>
                                    </label>
                                </div>
                            <?php
                            }
                        ...
                        <h6 class="fw-bold mb-3 text-primary small text-uppercase">
                            <i class="fa-solid fa-star me-1"></i> Valoración
                        </h6>
                        <div id="filter-rating" class="list-group mb-4">
                            <label class="list-group-item d-flex align-items-center gap-2 rating-option">
                        ...
                        <!-- Ubicación -->
                        <h6 class="fw-bold mb-3 text-primary small text-uppercase">
                            <i class="bi bi-geo-alt me-1"></i>Corregimiento / Barrio
                        </h6>
                        <select class="form-select form-select-sm rounded-3 mb-4" id="filter-location">
                            <option value="">---</option>
                            <?php
                                foreach ($neighborhoodsEnableds as $key => $value) {
                                    echo '<option value="'.$value["f106_id"].'">'.$value["f106_corregimiento_barrio"].'</option>';
                                }
                            ?>
                        </select>
            ...
            <section class="col-lg-9">
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-3 p-4">
                        <div>
                            <h4 class="fw-bold text-primary mb-1" id="list-title">Negocios en <?php echo $location[0]["f104_municipio"]; ?></h4>
                            <p class="text-muted small mb-0" id="list-description">
                                <i class="bi bi-building me-1"></i>Mostrando <strong><?php echo $totalBusiness[0]["Total"]; ?></strong> negocios disponibles
                            </p>
                        </div>
                            ...
                            <div class="col-md-9">
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-2">
                                        ...
                                        <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3 small fw-semibold"><?php echo ucfirst(strtolower(substr($value["f102_tipo_negocio"], 0, strlen($value["f102_tipo_negocio"]) - 1))); ?></span>
                                    </div>
